...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::skill::create_skill_entry,
            commands::skill::delete_skill,
            commands::skill::delete_skill_entry,
            commands::skill::duplicate_skill,
            commands::skill::export_skill,
            commands::skill::get_skill_detail,
            commands::skill::get_skill_file_content,
            commands::skill::import_skill_assets,
            commands::skill::import_skill_directory,
            commands::skill::install_skill_template,
            commands::skill::list_skill_templates,
            commands::skill::list_skills,
            commands::skill::open_skill_directory,
            commands::skill::refresh_skill,
            commands::skill::save_skill_file_content,
